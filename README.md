...
### Parser
For front end parser, information can be found in [README.md](https://github.com/eou/php-parser/blob/master/README.md) and [DEV.md](https://github.com/eou/php-parser/blob/master/plugin/DEV.md).
...
More details see [evaluator/README.md](https://github.com/eou/php-interpreter/blob/master/src/interpreter/evaluator/README.md).

## Development

See [DEV.md](https://github.com/eou/php-interpreter/blob/master/DEV.md).
